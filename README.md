...
<img src="https://capsule-render.vercel.app/api?type=waving&color=0:1a1b27,100:414868&height=200&section=header&text=Welcome%20to%20Abhishek%27s%20GitHub&fontSize=42&fontColor=c0caf5&fontAlignY=35&desc=SaaS%20Builder%20%E2%80%A2%20Full-Stack%20Developer&descSize=18&descAlignY=55" width="100%"/>

<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=7AA2F7&center=true&vCenter=true&width=500&lines=Building+SaaS+products+end+to+end;Next.js+%E2%80%A2+React+%E2%80%A2+TypeScript+%E2%80%A2+Python;From+idea+to+deployed+MVP" alt="Typing SVG" />
...
<a href="YOUR_PORTFOLIO_URL"><img src="https://img.shields.io/badge/Portfolio-414868?style=for-the-badge&logo=googlechrome&logoColor=white"/></a>
-->
...
- 🚀 I build **SaaS products end to end** — from idea and branding to deployed MVP
- 🛠️ Shipped **15+ projects**: interview-prep platforms, client management desktop apps, finance & habit trackers, browser extensions, and India-focused tax tooling
- 💡 I like **local-first and offline-capable** apps as much as full-stack cloud products
- 🎮 Occasionally I build games — like a Python/Pygame arcade space shooter with procedural art
- 🌱 Currently exploring **AI-powered product features** and scaling SaaS MVPs
